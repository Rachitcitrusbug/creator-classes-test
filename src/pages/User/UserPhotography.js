...
import Photo1 from '../../assets/images/user-home/photography.jpg';
import Photo2 from '../../assets/images/user-home/photography2.jpg';
import Photo3 from '../../assets/images/user-home/photography3.jpg';
import Photo4 from '../../assets/images/user-home/photography4.jpg';
              ...
              <div className="common-feed-card-slider-bx-big">
                <div className="our-video-img-thumb">
                  <div className="img-thumb">
                    {' '}
                    <img src={Photo1} className="img-fluid img-responsive" alt="image" />{' '}
                  </div>
            ...
            <div className="col-lg-6 col-md-12 right-small-img-order">
              <div className="common-feed-card-slider-bx-half-small">
                <div className="our-video-img-thumb">
                  <div className="img-thumb">
                    {' '}
                    <img src={Photo2} className="img-fluid img-responsive" alt="image" />{' '}
                  </div>
                  <div className="like-box-abs">
                    {' '}
                    <button className="like-button">
              ...
              <div className="common-feed-card-slider-bx-half-small">
                <div className="our-video-img-thumb">
                  <div className="img-thumb">
                    {' '}
                    <img src={Photo3} className="img-fluid img-responsive" alt="image" />{' '}
                  </div>
                  <div className="like-box-abs">
                    {' '}
                    <button className="like-button">
              ...
              <div className="common-feed-card-slider-bx-half-small">
                <div className="our-video-img-thumb">
                  <div className="img-thumb">
                    {' '}
                    <img src={Photo4} className="img-fluid img-responsive" alt="image" />{' '}
                  </div>
                  <div className="like-box-abs">
                    {' '}
                    <button className="like-button">
